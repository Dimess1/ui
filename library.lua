...
function QuantomLib:CreateWindow(config)
    ...
    function Window:CreateTab(config)
        ...
        function Tab:AddKeybind(config)
            local currentKey = config.Default or Enum.KeyCode.Q
            ...
            KeybindButton.Size = UDim2.new(0, isMobile and 80 or 70, 0, isMobile and 26 or 22)
            KeybindButton.Position = UDim2.new(1, isMobile and -90 or -80, 0.5, isMobile and -13 or -11)
            ...
            ToggleIndicator.BackgroundColor3 = Theme.Success
            ToggleIndicator.BorderSizePixel = 0
            ToggleIndicator.ZIndex = 5
            ToggleIndicator.Parent = KeybindFrame
            ...
            KeybindButton.MouseEnter:Connect(function()
                if not listening then
                    TweenService:Create(KeybindButton, TweenInfo.new(0.15), {
                        BackgroundColor3 = Theme.Surface
                    }):Play()
                end
            end)
                ...
                connection = UserInputService.InputBegan:Connect(function(input, gameProcessed)
                    ...
                    if input.UserInputType == Enum.UserInputType.Keyboard then
                        ...
                        Window:Notify({
                            ...
                            Message = config.Name .. " agora é " .. currentKey.Name,
                            Type = "Success",
                            Duration = 3
                        })
                    end
            ...
            UserInputService.InputBegan:Connect(function(input, gameProcessed)
                if gameProcessed or not keybindActive or listening then return end
            ...
            KeybindButton.MouseButton2Click:Connect(function()
                ...
                TweenService:Create(ToggleIndicator, TweenInfo.new(0.2), {
                    BackgroundColor3 = keybindActive and Theme.Success or Theme.Error
                }):Play()

                Window:Notify({
                    Title = keybindActive and "Keybind Ativado" or "Keybind Desativado",
                    Message = config.Name .. " foi " .. (keybindActive and "ativado" or "desativado"),
                    Type = keybindActive and "Success" or "Warning",
                    Duration = 2
                })
            end)
            ...
            return {
                ...
                SetActive = function(self, active)
                    ...
                    ToggleIndicator.BackgroundColor3 = keybindActive and Theme.Success or Theme.Error
                end,
